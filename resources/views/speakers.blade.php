      ...
      <div class="row">
        <div class="col-lg-6 align-self-center mb-5 mb-lg-0">
          <div class="innovative-wrapper">
            <h3 class="primary-text">Innovative With Experience <br class="d-none d-xl-block"> Conference</h3>
        ...
        <div class="col-lg-6 pl-xl-5">
          ...
          <div class="clockdiv-content text-center">
            <p class="h4 primary-text2 mb-2">November 20,2020</p>
      ...
      <div class="row">
        <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
          <div class="card-speaker">
            <img class="card-img rounded-0" src="frontend/img/home/parvezsir.jpg" alt="">
            <div class="speaker-footer">
              <h4>Fasi Ahmed Parvez</h4>
              <p>HOD of CSE at BITSWGL</p>
            </div>
            <div class="speaker-overlay">
              <ul class="speaker-social">
                <li><a href="#"><i class="ti-facebook"></i></a></li>
                <li><a href="#"><i class="ti-twitter-alt"></i></a></li>
                <li><a href="https://instagram.com/deekshith_reddy1?igshid=1h6i88ez1dlw4"><i class="ti-instagram"></i></a></li>
        ...
        <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
          <div class="card-speaker">
            <img class="card-img rounded-0" src="frontend/img/home/arunsir.jpg" alt="">
            <div class="speaker-footer">
              <h4>Arun Kumar Arigala</h4>
              <p>Professor at @BITSWGL</p>
            </div>
            <div class="speaker-overlay">
              <ul class="speaker-social">
                <li><a href="#"><i class="ti-facebook"></i></a></li>
        ...
        <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
          <div class="card-speaker">
            <img class="card-img rounded-0" src="frontend/img/home/sridevimam.jpg" alt="">
            <div class="speaker-footer">
              <h4>SRI DEVI</h4>
              <p>Professor at @BITSWGL</p>
            </div>
        ...
        <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
          <div class="card-speaker">
            <img class="card-img rounded-0" src="frontend/img/home/ashishsir.jpg" alt="">
            <div class="speaker-footer">
              <h4>ASHISH LADDA</h4>
              <p>Assistant Professor at @BITSWGL</p>
            </div>
            <div class="speaker-overlay">
              <ul class="speaker-social">
                <li><a href="#"><i class="ti-facebook"></i></a></li>
        ...
        <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
          <div class="card-speaker">
            <img class="card-img rounded-0" src="frontend/img/home/jayasreemam.jpg" alt="">
            <div class="speaker-footer">
              <h4>JAYA SREE</h4>
              <p>@BITSWGL</p>
            </div>
        ...
        <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
          <div class="card-speaker">
            <img class="card-img rounded-0" src="frontend/img/home/srinivassir.jpg" alt="">
            <div class="speaker-footer">
              <h4>SRINIVAS</h4>
              <p>Professor at @BITSWGL</p>
            </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |  <i class="fa fa-heart" aria-hidden="true"></i> Designed and developed by <a href="https://www.instagram.com/deekshith_reddy1/" target="_blank">Deekshith Reddy</a>
