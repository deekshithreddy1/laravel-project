    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container box_1620">
          <a class="navbar-brand logo_h" href="home"><img src="frontend/img/bits.png" alt=""width="120" height="120"></a>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Desigend and developed  <i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">Deekshith Reddy</a>
